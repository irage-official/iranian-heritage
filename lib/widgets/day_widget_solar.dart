...
class DayWidgetSolar extends StatelessWidget {
  final String mainDate; // Jalali day (string to allow Persian digits)
  final String? equivalentDate; // Gregorian day string
  final bool isSelected;
  final bool isToday;
  final bool isCurrentMonth;
  final int weekdayGregorian; // DateTime.weekday 1=Mon ... 7=Sun
  final bool isOffDay; // generic off day flag (e.g., public holiday)
  final List<Color> eventIndicatorColors;

  const DayWidgetSolar({
    super.key,
    required this.mainDate,
    this.equivalentDate,
    required this.weekdayGregorian,
  ...
  bool get _isSolarFriday => weekdayGregorian == DateTime.friday;
  ...
  Color _getMainColor(BuildContext context) {
    ...
    if (isOffDay) return TCnt.errorMd(context);
